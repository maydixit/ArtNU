...
public abstract class CameraActivity extends AppCompatActivity implements OnImageAvailableListener {
    ...
    final CameraConnectionFragment fragment =
        CameraConnectionFragment.newInstance(
            new CameraConnectionFragment.ConnectionCallback() {
              @Override
              public void onPreviewSizeChosen(final Size previewSize, final Size cameraSize, final int rotation) {
                CameraActivity.this.onPreviewSizeChosen(previewSize, cameraSize, rotation);
              }
            },
            this,
            getLayoutId(),
  ...
  protected abstract void onPreviewSizeChosen(final Size previewSize, final Size size, final int rotation);
